...
<div ng-show="tab">
<div name="#button_div">
<a class="button button-primary" ng-click="show(false)">Go Back</a>
</div>
<div>
<center>
<canvas id="cfpaBarChart" width="700" height="400"></canvas>
<h5>CFPA Chart</h5>
</center>
</div>
<div>
<center>
<canvas id="dfidBarChart" width="700" height="400"></canvas>
<h5>DFID Chart</h5>
</center>
</div>
<div>
<center>
<canvas id="ofdaBarChart" width="700" height="400"></canvas>
<h5>OFDA Chart</h5>
</center>
</div>
<div>
<center>
<canvas id="privateBarChart" width="700" height="400"></canvas>
<h5>Private Funds Chart
</center>
</div>
...
<div class="six columns"><a class="button button-primary" href="#button_div" ng-click="show(true)">View Donors Chart</a></div>
</div>
