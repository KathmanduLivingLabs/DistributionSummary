...
```{r, echo=FALSE, message=FALSE}
knitr::kable(distribution_summary, 'html', table.attr='class=``',col.names = c ("District","VDC","Donor","NFRI Allocated","NFRI Distributed","Cash Allocated","Cash Distributed"))
```
...
<script type="text/javascript" src="aggBarChart.js"></script>
