...
dataCSVDonor = getURI("http://api.ona.io/api/v1/data/65052.csv", userpwd=upass, httpauth = 1L)
donors = read.csv(textConnection(dataCSVDonor), na.strings="n/a")
dataCSVDistributions = getURI("http://api.ona.io/api/v1/data/65043.csv", userpwd=upass, httpauth = 1L)
...
# distributions_dfid_NFI = filter(donors_NFI, donors_NFI$distribution_information.distribution_donor == "dfid") %>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedNFI_DFID = sum(distribution_information.number_of_kits, na.rm = TRUE))
# 
# distributions_dfid_cash = filter(donors_cash, donors_cash$distribution_information.distribution_donor == "dfid") %>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedCash_DFID = sum(distribution_information.cash_recipients, na.rm = TRUE))
# 
# distributions_cfpa_NFI = filter(donors_NFI, donors_NFI$distribution_information.distribution_donor == "cfpa")%>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedNFI_CFPA = sum(distribution_information.number_of_kits, na.rm = TRUE))
# 
# distributions_cfpa_cash = filter(donors_cash, donors_cash$distribution_information.distribution_donor == "cfpa") %>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedCash_CFPA = sum(distribution_information.cash_recipients, na.rm = TRUE))
# 
# distributions_ofda_NFI = filter(donors_NFI, donors_NFI$distribution_information.distribution_donor == "ofda")%>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedNFI_OFDA = sum(distribution_information.number_of_kits, na.rm = TRUE))
# 
# distributions_ofda_cash = filter(donors_cash, donors_cash$distribution_information.distribution_donor == "ofda") %>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedCash_OFDA = sum(distribution_information.cash_recipients, na.rm = TRUE))
# 
# distributions_private_NFI = filter(donors_NFI, donors_NFI$distribution_information.distribution_donor == "private")%>%
#   group_by(distribution_information.vdc_name) %>% 
#   summarize(PlannedNFI_Private = sum(distribution_information.number_of_kits, na.rm = TRUE))
# 
# distributions_private_cash = filter(donors_cash, donors_cash$distribution_information.distribution_donor == "private") %>%
#   group_by(distribution_information.vdc_name) %>% 
...
# 
donor_vdc_summary = merge(VDC_List, distribution_summary, by.x = "VDC" ,by.y = "distribution_information.vdc_name" )
# 
...
# 
donor_vdc_summary$DistributedNFI = as.numeric(gsub(",","",donor_vdc_summary$DistributedNFI))
donor_vdc_summary$DistributedCash = as.numeric(gsub(",","",donor_vdc_summary$DistributedCash))
donor_vdc_summary$PlannedNFI = as.numeric(gsub(",","",donor_vdc_summary$PlannedNFI))
donor_vdc_summary$PlannedCash = as.numeric(gsub(",","",donor_vdc_summary$PlannedCash))


donor_vdc_summary$difd_cash = donor_vdc_summary$dfid_cash_multi * donor_vdc_summary$DistributedCash
donor_vdc_summary$ofda_cash = donor_vdc_summary$ofda_cash_multi * donor_vdc_summary$DistributedCash
donor_vdc_summary$cfpa_cash = donor_vdc_summary$cfpa_cash_multi * donor_vdc_summary$DistributedCash
donor_vdc_summary$private_cash = donor_vdc_summary$private_cash_multi * donor_vdc_summary$DistributedCash

donor_vdc_summary$difd_nfi = donor_vdc_summary$dfid_kit_multi * donor_vdc_summary$DistributedNFI
donor_vdc_summary$ofda_nfi = donor_vdc_summary$ofda_kit_multi * donor_vdc_summary$DistributedNFI
donor_vdc_summary$cfpa_nfi = donor_vdc_summary$cfpa_kit_multi * donor_vdc_summary$DistributedNFI
donor_vdc_summary$private_nfi = donor_vdc_summary$private_kit_multi * donor_vdc_summary$DistributedNFI

donor_vdc_summary$PlannedCash_DFID = donor_vdc_summary$dfid_cash_multi * donor_vdc_summary$PlannedCash
donor_vdc_summary$PlannedCash_OFDA = donor_vdc_summary$ofda_cash_multi * donor_vdc_summary$PlannedCash
donor_vdc_summary$PlannedCash_CFPA = donor_vdc_summary$cfpa_cash_multi * donor_vdc_summary$PlannedCash
donor_vdc_summary$PlannedCash_Private = donor_vdc_summary$private_cash_multi * donor_vdc_summary$PlannedCash

donor_vdc_summary$PlannedNFI_DFID = donor_vdc_summary$dfid_kit_multi * donor_vdc_summary$PlannedNFI
donor_vdc_summary$PlannedNFI_OFDA = donor_vdc_summary$ofda_kit_multi * donor_vdc_summary$PlannedNFI
donor_vdc_summary$PlannedNFI_CFPA = donor_vdc_summary$cfpa_kit_multi * donor_vdc_summary$PlannedNFI
donor_vdc_summary$PlannedNFI_Private = donor_vdc_summary$private_kit_multi * donor_vdc_summary$PlannedNFI

donor_table_details = c("Cash Allocated","Cash Distributed","NFI Allocated", "NFI Distributed","Total NFI Planned", "Total Cash Planned")

donor_table_cfpa = c(sum(donor_vdc_summary$PlannedCash_CFPA,na.rm = T),sum(donor_vdc_summary$cfpa_cash, na.rm = T),sum(donor_vdc_summary$PlannedNFI_CFPA, na.rm = T),sum(donor_vdc_summary$cfpa_nfi, na.rm = T),1900,0)

donor_table_dfid = c(sum(donor_vdc_summary$PlannedCash_DFID,na.rm = T),sum(donor_vdc_summary$difd_cash, na.rm = T),sum(donor_vdc_summary$PlannedNFI_DFID, na.rm = T),sum(donor_vdc_summary$difd_nfi, na.rm = T),3000,3000)
...
donor_table_private = c(sum(donor_vdc_summary$PlannedCash_Private,na.rm = T),sum(donor_vdc_summary$private_cash, na.rm = T),sum(donor_vdc_summary$PlannedNFI_Private, na.rm = T),sum(donor_vdc_summary$private_nfi, na.rm = T),15000,17000)
